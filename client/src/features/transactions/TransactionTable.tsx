...
export function TransactionTable({ transactions, loading }: Props) {
  ...
  return (
    <Card>
      {/* Table header */}
      <div className="grid grid-cols-[1fr_2fr_1fr_1fr] gap-4 px-5 py-2.5 bg-gray-50 border-b border-gray-200 rounded-t-xl">
      ...
      <CardContent className="p-0">
        {transactions.map((tx, idx) => (
          <div
            key={tx.id}
            className={cn(
              'grid grid-cols-[1fr_2fr_1fr_1fr] gap-4 px-5 py-3 items-center',
